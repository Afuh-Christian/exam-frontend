import 'package:exam_front_end/Components/DropdowmAnswerButtons.dart';
              ...
              AnswerButtonWidget(
                  ...
                  btnClicked: () {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) =>
                            CommentSectionFullSreen(answerId : "a;sdkfjasdkfjadkfjad")),
...
class CommentSectionFullSreen extends StatefulWidget {
  CommentSectionFullSreen({super.key, required this.provider , required this.answerId});
  final ExamProvider provider;
  String answerId ;

  @override
  State<CommentSectionFullSreen> createState() =>
      _CommentSectionFullSreenState();
}

class _CommentSectionFullSreenState extends State<CommentSectionFullSreen> {
  int incMaxLines = 1;
  String commentInputValue = "";

  void setMaxLines(String value) {
    var characterEnd = (50 * MediaQuery.of(context).size.width / 360) ;
    int maxLineCalculate = (1 + (value.length / characterEnd).floor());
    incMaxLines = maxLineCalculate > 8 ? 8 : maxLineCalculate;
  }
